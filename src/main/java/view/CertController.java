...
public class CertController implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources) {
        //associates cells in the view with Certification object attributes
    ...
    private void close(){
        ...
        person.setCertifications(new ArrayList(certs));

        parentController.getAddController().setCerts(new ArrayList(certs));
